...
class AppPrefenHelper @Inject constructor(
    context: Context,
    ...
    override fun getCurrentUserLoggedInMode() = mPrefs.getInt(
        ...
        AppConstans.LoggedInMode.LOGGED_IN_MODE_LOGGED_OUT.type
    )

    override fun getCurrentUserName(): String {

        return mPrefs.getString(Companion.PREF_KEY_CURRENT_USER_NAME, "ABC")!!;
    }
    ...
    override fun getCurrentUserId(): Long? {
        val userId = mPrefs.getLong(PREF_KEY_CURRENT_USER_ID, AppConstans.NULL_INDEX)
        return when (userId) {
            AppConstans.NULL_INDEX -> null
            else -> userId
        }
    }

    override fun setCurrentUserId(userId: Long?) {
        val id = userId ?: AppConstans.NULL_INDEX
        mPrefs.edit { putLong(PREF_KEY_CURRENT_USER_ID, id) }
    }

    override fun setCurrentUserLoggedInMode(mode: AppConstans.LoggedInMode) {
